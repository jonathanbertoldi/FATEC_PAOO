 ...
 * @author Jonathan
 */
public class ContratoControlador extends FileControlador{
    
    public String nomeArquivo(Carro carro) {
        String retorno = urlContratos() + carro.getAnunciante().getNome() + "_" +
    ...
    public String gravarContrato(Carro carro) {
        try {
            ...
            String contrato = "<html>\n" +
                ...
                "        <p><b>VENDEDOR</b>: "+carro.getAnunciante().getNome()+" , inscrito no C.P.F. nº "+carro.getAnunciante().getCpf()+" , residente e domiciliado em "+carro.getAnunciante().getEndereco().getRua()+", nº "+carro.getAnunciante().getEndereco().getNumero()+", Cep "+carro.getAnunciante().getEndereco().getCep()+", no Estado "+carro.getAnunciante().getEndereco().getEstado().toString()+", cidade de "+carro.getAnunciante().getEndereco().getCidade()+";</p>\n" +
                "\n" +
                "        <p><b>COMPRADOR</b>: "+carro.getComprador().getNome()+" , inscrito no C.P.F. nº "+carro.getComprador().getCpf()+" , residente e domiciliado em "+carro.getComprador().getEndereco().getRua()+", nº "+carro.getComprador().getEndereco().getNumero()+", Cep "+carro.getComprador().getEndereco().getCep()+", no Estado "+carro.getComprador().getEndereco().getEstado().toString()+", cidade de "+carro.getComprador().getEndereco().getCidade()+";</p>\n" +
                "\n" +
